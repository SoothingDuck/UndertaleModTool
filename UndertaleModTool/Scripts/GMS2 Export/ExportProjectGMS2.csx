...
)
{
    ...
    for (int i = 0; i < Data.TextureGroupInfo.Count; i++)
    {
        ...
        writer.WriteLine(
            "    {\"resourceType\":\"GMTextureGroup\",\"resourceVersion\":\"1.3\",\"name\":\""
                + tgroup.Name.Content
                + "\",\"autocrop\":true,\"border\":2,\"compressFormat\":\"bz2\",\"directory\":\"\",\"groupParent\":null,\"isScaled\":false,\"loadType\":\"default\",\"mipsToGenerate\":0,\"targets\":-1,},"
        );
    }
    writer.WriteLine("  ],");
    writer.WriteLine("}");
